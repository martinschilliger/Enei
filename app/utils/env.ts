...
export const env = {
  ...
  ENEI_FORWARD_CUSTOM_BODY_REGEX: parseRegex(
    process.env.ENEI_FORWARD_CUSTOM_BODY_REGEX,
  ),

  ENEI_FORWARD_CUSTOM_BODY_REPLACEMENT:
    process.env.ENEI_FORWARD_CUSTOM_BODY_REPLACEMENT,
